...
?>
    ...
    <div class="content_wrapper">
        ...
        $sql = 'SELECT i.incidentid,i.RegisteredBy,i.description,i.report_date,i.topic,o.operator_name,li.description,t.description,s.StatusID,o.operatorid,c.customerid,c.username
