...
?>
    ...
    AND s.StatusID=1 AND o.operatorid=3 ORDER BY i.incidentid ASC;';
        ...
        if ($stmt_select = mysqli_prepare($connect, $sql)) {
            ...
            mysqli_stmt_bind_result($stmt_select, $incidentID, $registered_by, 
            $description, $rep_date, $topic, $operatorName, $license, 
            $typeDesc, $status, $opeID, $deadline, $customer_username, $customerid);
